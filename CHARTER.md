...
- **Each product has its own Claude Project**, holding a few lines of instructions that point at both repositories and say how a session reaches the product repository — and no files of any kind (the Chairman's ruling, 6 September 2026; `HOW-WE-BUILD.md` governs). Prose written for him is said in chat or the pull request, and kept in neither a Project nor a repository. Projects do not share knowledge with each other; the rulebook is what they share.
