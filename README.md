...
**A park needs a refusal of its own (learned 21 September 2026).** A session may park a slice only on a refusal it was given itself, on that pull request, in that hour — never on a note, a roadmap line, a handover or another session's report saying the reviewer is out. One ask settles it in seconds and the refusal it earns is the park's evidence; an assumption earns nothing and cannot be checked later. This clears §13 as the same material failure in two separate product tasks, both in Hemz OS and both readable on the pull requests themselves. P47's signing view parked itself on 18 September at 19:10 with *“no ask has been spent — deliberately”* and sat there until 21 September, when one ask was answered in twelve seconds and the slice was read clean within the hour. P34's takings screen reported *“asked once”* on 21 September at 19:15 and again at 19:35 having posted no ask at all; its first real one, at 20:54, was answered in fifteen seconds. Neither was a misjudgement about a reviewer that was out — in both the reviewer was reading. On 21 September two Hemz OS sessions held finished slices all day on *"Codex has been out five days"*, one of them never having asked at all. The reviewer had been reading since 13:08 that day: six asks were accepted in a minute, four pull requests went green within a quarter of an hour, and the pull request that had never asked was answered the moment it did. The cost is not the waiting — it is that a session which stops for a reason that is not real is woken by nothing, because nothing happens. **So: ask, then park on the answer.**
