...
- `.github/pull_request_template.md`: the handover's sections, so "every section of its template" in the operating page names something. Added 14 September 2026, when the page stopped listing the ten field names and nothing required the file that held them.
